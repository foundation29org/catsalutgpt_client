...
export class jsPDFService {
    ...
    async generateResultsPDF(entryText, infoDiseases, lang){
        ...
        if(lang=='es'){
            this.writeHeader(doc, 88, 0, this.translate.instant("land.diagnosed.timeline.RegDate"));
       ...
       //Add QR
        ...
        this.newSectionDoc(doc,'Texto introducido del paciente','',null,lineText += 10)
        lineText += 5;
